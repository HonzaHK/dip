...
\projectinfo{
  ...
  % Abstrakt / Abstract
  abstract.cs={Předmětem této práce je provádění finanční analýzy a její programová podpora. V první části se práce zaměřuje na finanční analýzou obecně -- je zde shrnuta motivace, množina vstupních dat, výčet používaných metod a ukazatelů a závěry/popisy. Druhá část práce obsahuje popis návrhu, implementace a fungování nástroje, který je schopen provádět vybrané výpočty z finanční analýzy}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
