...
\projectinfo{
  ...
  % Abstrakt / Abstract
  abstract.cs={Finanční analýza je proces, při kterém... . V první části se práce zabývá finanční analýzou obecně -- Je zde shrnuta motivace, data, metody a závěry/popisy. Druhá část práce obsahuje popis návrhu, implementace a fungování nástroje, který je schopen provádět vybrané výpočty z finanční analýzy}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
