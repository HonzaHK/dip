...
\projectinfo{
  ...
  keywords.cs={finanční analýza, finanční zdraví}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={financial analysis, financial healthiness}, % klíčová slova v anglickém jazyce / keywords in english
  % Abstrakt / Abstract
  abstract.cs={Finanční analýza je proces, při kterém... . Tato práce se v první části zabývá finanční analýzou obecně -- . Druhá část obsahuje popis návrhu, implementace a fungování nástroje, který je schopen provádět automatizovan vybraných postupů finanční analýzy }, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
