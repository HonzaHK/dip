...
\begin{itemize}
	\item Next.js -- startovní balíček pro urychlení vývoje, obsahuje skripty pro spouštění, ladění a jednoduchý deployment aplikace, importuje také všechny užitečné knihovny (routování, serverová volání, dynamické importování)
