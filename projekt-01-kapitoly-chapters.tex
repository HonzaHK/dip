...
finanční výkazy tvořící účetní závěrku - VZZ a R.
...
K implementaci bude použita kombinace skriptovacích, značkovacích a dotazovacích jazyků. Pro klientskou část jsou to HTML, CSS a Javascript. Kód serveru bude v jazyce PHP s připojením na MySQL databázi.
...
Jeden z důvodů volby webového rozhraní
