...
Tento výběr nám ukládá pracovat se dvěma druhy vstupních dat. Pro podnik jsou vstupními daty výkazy účetní závěrky, pro investici vlastní výběr nejdůležitějších aspektů investice.

Po implementaci načítaní a uložení dat potřebných pro analýzu bylo možné začít s~implementací modulu pro provádění samotné analýzy.
