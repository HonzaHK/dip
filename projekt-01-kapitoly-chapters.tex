...
Finanční analýza obsahuje dvě navzájem popojené části\cite{kova}:
\begin{enumerate}
	\item kvalitativní (fundamentální) analýzu založenou na znalostech souvislostí mezi ekonomickými i mimoekonomickými jevy, zkušenostech odborníků a na jejich subjektivních odhadech
	\item kvantitativní (technickou) analýzu, která využívá matematické, statistické a jiné algoritmizovatelné postupy
\end{enumerate}
