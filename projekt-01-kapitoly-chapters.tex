...
V případě analýzy Du Pont se provádí rozklad ukazatele rentability vlastního kapitálu (ROE). Celé schéma 


\begin{figure}
  \centering
  \includegraphics[width=11cm]{img/dupont.png}
  \caption{Rozklad Du Pont \cite{sedl} (FP -- finanční páka, OA -- obrat aktiv)}
\end{figure}
