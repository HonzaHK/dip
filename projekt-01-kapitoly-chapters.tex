...
Společnosti zapsané v obchodním rejistříku jsou povinny vést podvojné účetnictví, z čehož zároveň vyplývá povinnost útovat podle účtové osnovy.
...
Vzhledem k nejedotné terminologii napříč celou finanční analýzou je žádoucí, aby při zobrazování výstupu uživatel bezpečně zjistil, o jaký ukazatel se jedná. To bude zajištěno zobrazením alternativních označení, případně možností přímo přejít do sekce, kde jsou jednotlivé ukazatele detailně vysvětleny.
