...
V~rámci horizontální analýzy bylo implementováno také mezipodnikové srovnání, je tak možné porovnávat vlastnosti podniků plynoucí z finančních výkazů (tržby, náklady,)
...
* zbavit se veci dokud ještě přináší požadované procento výnosu
...
Podle konceptu Redux, popsaném v sekci \ref{redux}, jsou všechna data na aplikační vrstvě ukládána do reducerů, jediných zdrojů informací o stavu aplikace. 
